export const components = [
    ...
    { ID:"8", type: 'COOLER', name: 'Water Cooler CPU NZXT Kraken Elite 360 RGB Preto', Descricao: 'Sistema de refrigeração líquida 360mm com iluminação RGB personalizável', price: 309.90, img: '../imagens/Componentes/16.png' },
    { ID:"9", type: 'COOLER', name: 'Corsair iCUE H150i Elite Capellix Liquid Cooler', Descricao: 'Cooler líquido 360mm com iluminação RGB Capellix para alta performance', price: 259.90, img: '../imagens/Componentes/25.png' },
    
    { ID:"10", type: 'MOTHERBOARD', Socket: 'AM4', DDR:"DDR4", name: 'Motherboard ATX ASUS ROG STRIX B550-F Gaming', Descricao: 'Placa-mãe ATX com suporte a PCIe 4.0 e Wi-Fi integrado', price: 199.90, img: '../imagens/Componentes/5.png' },
    { ID:"11", type: 'MOTHERBOARD', Socket: 'AM5', DDR:"DDR5", name: 'Motherboard Mini-ITX Gigabyte B650I Aorus Ultra', Descricao: 'Placa-mãe Mini-ITX com suporte a DDR5 e design ultra compacto', price: 319.90, img: '../imagens/Componentes/6.png' },
    { ID:"12", type: 'MOTHERBOARD', Socket: 'AM5', DDR:"DDR5", name: 'Motherboard ATX ASRock B650E Steel Legend WiFi', Descricao: 'Placa-mãe ATX robusta com suporte a DDR5 e Wi-Fi 6', price: 289.90, img: '../imagens/Componentes/17.png' },
    { ID:"13", type: 'MOTHERBOARD', Socket: 'LGA1700', DDR:"DDR4,DDR5", name: 'Motherboard ATX Gigabyte Z690 Aorus Elite AX WiFi', Descricao: 'Placa-mãe ATX para Intel de 12ª geração com Wi-Fi 6 e PCIe 5.0', price: 209.90, img: '../imagens/Componentes/18.png' },
    { ID:"14", type: 'MOTHERBOARD', Socket: 'AM4', DDR:"DDR4", name: 'Motherboard Micro-ATX Gigabyte B550M DS3H', Descricao: 'Placa-mãe Micro-ATX com suporte a PCIe 4.0 e 4 slots de memória', price: 119.90, img: '../imagens/Componentes/29.png' },
    { ID:"15", type: 'MOTHERBOARD', Socket: 'LGA1700', DDR:"DDR5", name: 'Motherboard ATX Asus Prime Z790-P WiFi', Descricao: 'Placa-mãe ATX para Intel com Wi-Fi 6 e excelente desempenho', price: 259.90, img: '../imagens/Componentes/36.png' },
    
    { ID:"16", type: 'CAIXA', name: 'Caixa ATX Corsair iCUE 4000X RGB Tempered Glass Preta', Descricao: 'Gabinete ATX com vidro temperado e iluminação RGB personalizada', price: 109.90, img: '../imagens/Componentes/7.png' },
    { ID:"17", type: 'CAIXA', name: 'Caixa Micro-ATX MSI MAG Pano M100R PZ Series Vidro Temperado', Descricao: 'Gabinete Micro-ATX compacto com design moderno e vidro temperado', price: 99.90, img: '../imagens/Componentes/8.png' },
    { ID:"18", type: 'CAIXA', name: 'Caixa ATX Lian Li PC-O11 Dynamic', Descricao: 'Gabinete ATX premium com excelente fluxo de ar e design elegante', price: 169.90, img: '../imagens/Componentes/19.png' },
    ...
    { ID:"29", type: 'ARMAZENAMENTO', name: 'SSD M.2 2280 Samsung 980 Pro 2TB', Descricao: 'SSD NVMe rápido com 2TB de capacidade e suporte a PCIe Gen 4.0', price: 169.90, img: '../imagens/Componentes/22.png' },
    
    { ID:"30", type: 'RAM', DDR:"DDR4", name: 'Memória RAM Corsair Vengeance LPX 16GB (2x8GB) DDR4-3200MHz', Descricao: 'Memória RAM com 16GB (2x8GB) de capacidade e alta velocidade para gaming', price: 49.90, img: '../imagens/Componentes/12.png' },
